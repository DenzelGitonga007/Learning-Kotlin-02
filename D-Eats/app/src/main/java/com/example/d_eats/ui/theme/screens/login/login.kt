package com.example.d_eats.ui.theme.screens.login
...
//    Set the column to occupy the entire screen
    Column (
        modifier = Modifier.fillMaxSize(),
        horizontalAlignment = Alignment.CenterHorizontally, // set the content aligned center
